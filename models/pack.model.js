/** model file for pack contains CRUD process */
...
exports.findByCriteria = (parameter) => {
    return new Promise((resolve, rejected) => {
        ...
        let params = Object
            ...
            .join(" and ")
        /** result:
         * params = ' nama_pack ' ="Kantong Plastik" and harga="2000" '
         * ------------------------------------------------
         */
 ...
 exports.update = (dataObject, parameter) => {
    return new Promise((resolve, rejected) => {
        ...
        let updateData = Object
            ...
            .join()
        /** result:
         * updateData = ' nama_pack="Kantong Plastik", harga="2000" '
         * ------------------------------------------------
         */
